...
////        List<ActionRule> rules = parser.parse(strategy.getScript());
////
...
////
////                boolean conditionMet = evaluate(leftVal, rightVal, c.getOperator());
////
////                if (conditionMet) {
////                    if ("BUY".equals(rule.getAction()) && !holding) {
...
////                        holding = true;
////                    } else if ("SELL".equals(rule.getAction()) && holding) {
////                        trades.add(Trade.builder()
////                                .date(candle.getDate())
////                                .price(candle.getClose())
////                                .action("SELL")
...
//        }
//
//        // 🔥 Fallback: if type is a plain number like "30", "1000", etc.
//        try {
